...
//		System.out.println(stat);
	...
	@CrossOrigin(origins="http://localhost:4200")
	public void getAllCandidateToCsv(@RequestBody search searchObj,HttpServletResponse servletResponse) throws IOException{
//		System.out.println("The portal controller hit for export CSV");
		servletResponse.setContentType("text/csv");
		String headerValue="attachment; filename=search.csv";
		...
		for(Candidate candi:cand) {
			csvWriter.write(candi,nameMapping);
		}
