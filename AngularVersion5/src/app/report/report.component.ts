...
export class ReportComponent implements OnInit {
  ...
  filter:any[] = [
    ...
    {value: 'average', viewValue: 'Average',placeHoldervalue:'Enter candidate Id'},
  ];
  ...
  // setplaceholder(){
  //   if(this.selectedOption=="quaterlyreport"){
  //     this.selectedOption="Enter Q1,Q2,Q3,Q4"
  //   }
  //   else if(this.selectedOption=="monthlyreport"){
  //     this.selectedOption=="Enter month number"
  //   }

  //   else if(this.selectedOption=="average"){
  //     this.selectedOption="Enter candidate Id"
  //   }
  // }
